...
class RCNN(object):
    ...
    def build_backbone(input_tensor, architecture, stage5=False, train_bn=None):
        ...
        assert architecture in ["resnet50", "resnet101", "novel"]
        if "resnet" in architecture:
            ...
            if stage5:
                ...
                C5 = None
        elif architecture == "novel":
            #Implement our novel architecture
            #Stage 1:
            #x = KL.ZeroPadding2D((3, 3))(input_tensor)
    ...
    def build_feature_maps(self, input_tensor):
        ...
        if C5 != None:
        ...
        else: #Hagan's model doesn't have a C5 layer so we only build P5 down to P2
            # Top-down Layers
            ...
            P3 = KL.Conv2D(self.config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p3")(P3)
            P4 = KL.Conv2D(self.config.TOP_DOWN_PYRAMID_SIZE, (3, 3), padding="SAME", name="fpn_p4")(P4)
            P5 = None #Our novel model has no C5 layer therefore P5 is not calculated
