...
if __name__ == '__main__':
    #VAL_PATH='/scratch/07655/jsreyl/imgs/wild_type_micrographs_formated'
    VAL_PATH='/scratch/07655/jsreyl/imgs/wild_type_cropped_augmented_iou075'
    # TRAIN_PATH='/scratch/07655/jsreyl/imgs/rcnn_dataset_full/train'
    # VAL_PATH='/scratch/07655/jsreyl/imgs/rcnn_dataset_full/val'
    # TRAIN_PATH='/scratch/07655/jsreyl/imgs/cropped_iou075_augmented_rcnn_full/train'
    #VAL_PATH='/scratch/07655/jsreyl/imgs/cropped_iou075_augmented_rcnn_full/val'
    crop_size = (1024, 1024)
    step_size = (500,500)
    # expand_images_crops(crop_size, step_size, TRAIN_PATH, '/scratch/07655/jsreyl/imgs/cropped_iou075_rcnn_full/train', rewrite= True)
    #expand_images_crops(crop_size, step_size, VAL_PATH, '/scratch/07655/jsreyl/imgs/wild_type_cropped_iou075/', rewrite = True)
    #expand_images(TRAIN_PATH, rewrite= True)
